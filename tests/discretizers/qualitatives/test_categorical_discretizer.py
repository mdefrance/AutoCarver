...
from AutoCarver.features import CategoricalFeature, Features, FeaturesOptions, GroupedList
...
def test_categorical_discretizer(x_train: pd.DataFrame, target: str) -> None:
    ...
    features = Features(categoricals=categoricals, options=FeaturesOptions(default=str_default))
    ...
    features = Features(categoricals=categoricals + ["Qualitative"], options=FeaturesOptions(default=str_default))
