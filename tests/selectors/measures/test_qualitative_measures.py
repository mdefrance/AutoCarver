...
def test_compute_association(measure: BaseMeasure, series_data: pd.Series) -> None:
...
def test_validate_with_computed_association_below_threshold(measure: BaseMeasure, series_data: pd.Series) -> None:
...
def test_validate_with_computed_association_above_threshold(measure: BaseMeasure, series_data: pd.Series) -> None:
...
def test_compute_association_with_nans(measure: BaseMeasure, nan_series_data: pd.Series) -> None:
    """checks that correlation measurement works"""
...
def test_validate_with_computed_association_below_threshold_with_nans(
    measure: BaseMeasure, nan_series_data: pd.Series, series_data: pd.Series
) -> None:
    """checks that correlated features are not removed"""
