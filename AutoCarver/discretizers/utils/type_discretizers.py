...
class StringDiscretizer(BaseDiscretizer):
    ...
    * Converts floats of int to int
    ...
    def fit(self, X: DataFrame, y: Series | None = None) -> "StringDiscretizer":  # pylint: disable=W0222
...
class TimedeltaDiscretizer(BaseDiscretizer):
    ...
    * Keeps NaN inplace
    ...
    @extend_docstring(BaseDiscretizer.fit)
    def fit(self, X: DataFrame, y: Series | None = None) -> "TimedeltaDiscretizer":  # pylint: disable=W0222
        self._log_if_verbose()  # verbose if requested
